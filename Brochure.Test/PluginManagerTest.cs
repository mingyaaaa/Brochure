...
namespace Brochure.Test
{
    ...
    public class PluginManagerTest
    {
        ...
        public void TestResolvePlugins ()
        {
            ...
            var loadContextMock = new Mock<PluginsLoadContext> (service.Object);
            var reflectorUtilMock = new Mock<IReflectorUtil> ();
            var configurationRootMock = new Mock<IConfigurationRoot> ();
            var pluginManager = new PluginManagers (dirMock.Object, jsonUtilMock.Object, objectFactoryMock.Object, reflectorUtilMock.Object);
            var path = "aaa";
            ...
            objectFactoryMock.Setup (t => t.Create<PluginsLoadContext> (service.Object))
            ...
            var pp = pluginManager.ResolvePlugins (path, service.Object);
